...
export async function createTicketOrder(travelerId: number, flightId: number): Promise<number> {
  // validates
  ...
  const rollback = async () => {
    await freeTicket(travelerId, flightId, ticketId);
  };
